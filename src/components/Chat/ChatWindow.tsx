...
import { Info, Sun, Moon, LogOut, AlertTriangle } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Join a room using an invite link to start chatting.</p>
        </div>
      </div>
    );
  }
